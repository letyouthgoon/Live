...
public class UserInfo {
    ...
    public void login(Context context, String phone) {
        ...
        mIsLogin = true;
        SharedPreferences.Editor sharedata =  context.getSharedPreferences(Constants.LOCAL_DATA, Context.MODE_APPEND).edit();
    ...
    public void logout(Context context){
        SharedPreferences.Editor sharedata =  context.getSharedPreferences(Constants.LOCAL_DATA, Context.MODE_APPEND).edit();
        sharedata.putString(Constants.LOCAL_PHONE, "");
        sharedata.commit();
    	mIsLogin = false;
    }
